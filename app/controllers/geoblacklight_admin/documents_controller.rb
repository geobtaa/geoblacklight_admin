...
# GeoblacklightAdmin::DocumentsController
module GeoblacklightAdmin
  class DocumentsController < GeoblacklightAdmin::AdminController
    ...
    def create
      ...
      respond_to do |format|
        if @document.save
          format.html { redirect_to geoblacklight_admin.documents_path, notice: "Document was successfully created." }
